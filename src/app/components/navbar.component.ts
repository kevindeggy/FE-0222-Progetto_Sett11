...
@Component({
  ...
  template: `
    ...
    <a class="nav-link" aria-current="page" [routerLink]="['/carrello']" routerLinkActive="active"><button type="button" class="btn bg-secondary position-relative">
    <i class="bi bi-bag"></i>
...
export class NavbarComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.srvCart.subBadgeNum.subscribe((res) => { this.countCart = res }) //subscrive my badge number on subject's service
  }
