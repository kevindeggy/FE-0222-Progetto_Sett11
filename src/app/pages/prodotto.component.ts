...
@Component({
  template: `
    <div class="card text-center">
      <div class="card-header">Product <i class="bi bi-apple"></i> Details</div>
    ...
    <ng-container *ngIf="addToCartLoad">
      <p class="bg-secondary p-3 w-50 mx-auto mt-3 text-dark text-center">{{ productSelected.name | uppercase }} added to Cart!</p>
    </ng-container>
  `,
  styles: [],
})
export class ProdottoComponent implements OnInit {
  ...
  productSelected: ProductModel = {
    //product that I show with my Id selected, at starting is on waiting status
    id: 0,
    name: "waiting...",
    price: 0,
    description: "waiting...",
  ...
  ngOnInit(): void {
    ...
    this.srvProd.getDetailsProduct(this.productIdSelected).subscribe((ris) => {
      //call my getFunction that return my product with my id selected
