...
@Component({
  ...
  <div class="card text-center">
    <div class="card-header">
      Apple <i class="bi bi-apple"></i> Store
    </div>
  </div>
  <div class="container-fluid d-flex p-5 mb-5">
    <div class="col-md-5 p-lg-5 mx-auto my-5">
      <h1 class="display-4 fw-normal"><i class="bi bi-apple"></i> Apple</h1>
      <p class="lead fw-normal">Stay hungry, Stay foolish! <br> <cite>- Steve Jobs</cite> <br><br> Welcome! <br> This is the new Apple Store</p>
